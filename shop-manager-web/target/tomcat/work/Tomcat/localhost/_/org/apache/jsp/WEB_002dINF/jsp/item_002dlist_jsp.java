 ...
 * Generated at: 2018-01-08 15:38:23 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \t//取得所有选中行数据，返回元素记录的数组数据。\r\n");
      ...
      out.write("        \t$.post(\"/rest/item/byId\",params, function(data){\r\n");
      out.write("            \t\t\tif(data.status == 200){\r\n");
      out.write("            \t\t\t\talert(data.data.price);\r\n");
      out.write("            \t\t\t}\r\n");
      out.write("            }); */\r\n");
      ...
      out.write("        \t\t\t//把商品价格进行格式化\r\n");
      out.write("        \t\t\tdata.priceView = E3.formatPrice(data.price);\r\n");
      out.write("        \t\t\t//在item-edit中的form中去加载数据\r\n");
