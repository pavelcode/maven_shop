...
public class TestActiveMQ {
	...
	public void testQueueProducer() throws Exception {
		...
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.0.128:61616");
		...
		TextMessage textMessage = session.createTextMessage("aaa hello activemq");
		//8、发送消息
